...
get_cluster_colors <- function(obj){
  ...
  real_colors <- c("dark gray","dark cyan","orange"); names(real_colors) <- corr$source
  cluster_colors <- real_colors; names(cluster_colors) <- corr$target
  return(list(real_colors,cluster_colors))
}
```

```{r plot-spectral-gold,fig.height=4,fig.width=6,fig.align="center"}
...
```{r plot-spectral-sparse,fig.height=4,fig.width=6,fig.align="center"}
...
```{r plot-spectral-het,fig.height=4,fig.width=9,fig.align="center"}
